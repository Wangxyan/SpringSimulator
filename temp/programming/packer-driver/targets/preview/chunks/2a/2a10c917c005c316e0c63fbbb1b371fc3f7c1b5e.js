    ...
    execute: function () {
      ...
      _export("ResourcesUtil", ResourcesUtil = class ResourcesUtil extends Component {
        ...
        */
        ...
        static createUI(path, parent) {
          var _this = this;

          return _asyncToGenerator(function* () {
            var pf = yield _this.getUIPrefabRes(path);
            var node = instantiate(pf);
        ...
        */
        ...
        static setSpriteFrame(path, sprite, clear, callback) {
          if (clear === void 0) {
            clear = true;
          }
        ...
        static setSpriteAtlasSpriteFrame(path, res, sprite) {
          if (sprite) {
            resources.load(path, SpriteAtlas, (err, atlas) => {
              ...
              var frame = atlas.getSpriteFrame(res);
        ...
        */
        ...
        loadRemoteImg(url) {
          assetManager.loadRemote(url, (err, imageAsset) => {
            if (!err && imageAsset) {
              var spFrame = this.cache[imageAsset._uuid];
