    ...
    execute: function () {
      ...
      _export("BattleUIManager", BattleUIManager = (_dec = ccclass('BattleUIManager'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class BattleUIManager extends Component {
        ...
        onCreateDieEffect(pos) {
          var key = 'blastItem';
          var blastItem = null;
          var blastPrefab = null;
          var parent = this.battleUIDownParent.getChildByName('Die');
        ...
        onCreateHeroHp(pos) {
          var key = 'heroHpItem';
          var heroHpItem = null;
          var heroHpPrefab = null;
          var parent = this.battleUIParent;
          var newPos = new Vec3(pos.x, pos.y - 30, 0);
        ...
        onCreateMonsterHp(com) {
          var key = 'monsterHpItem';
          var monsterHpItem = null;
          var monsterHpPrefab = null;
          var parent = this.battleUIParent;
        ...
        onCreateMonsterShadow(com) {
          var key = 'shadown';
          var monsterShadownItem = null;
          var monsterShadownPrefab = null;
          var parent = this.battleUIDownParent.getChildByName('Shadow');
