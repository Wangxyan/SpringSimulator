  ...
  return {
    ...
    execute: function () {
      ...
      _export("WeaponData", WeaponData = class WeaponData {
        ...
        init() {
          var weaponCfgArr = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
            error: Error()
          }), CfgMgr) : CfgMgr).getCfgDataArray(new (_crd && WeaponCfg === void 0 ? (_reportPossibleCrUseOfWeaponCfg({
            error: Error()
          }), WeaponCfg) : WeaponCfg)());

          for (var index = 0; index < weaponCfgArr.length; index++) {
            var element = weaponCfgArr[index];
        ...
        getWeaponCfgData() {
          var data = [];
          var arr = (_crd && CfgMgr === void 0 ? (_reportPossibleCrUseOfCfgMgr({
            error: Error()
          }), CfgMgr) : CfgMgr).getCfgDataArray(new (_crd && WeaponCfg === void 0 ? (_reportPossibleCrUseOfWeaponCfg({
            error: Error()
          }), WeaponCfg) : WeaponCfg)());
        ...
        getWeaponPool() {
          var arr = [];
          var data = (_crd && Util === void 0 ? (_reportPossibleCrUseOfUtil({
            error: Error()
