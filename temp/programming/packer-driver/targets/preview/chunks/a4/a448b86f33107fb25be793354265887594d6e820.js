  ...
  return {
    ...
    execute: function () {
      ...
      _export("SkillManager", SkillManager = (_dec = ccclass('SkillManager'), _dec2 = property(Node), _dec(_class = (_class2 = class SkillManager extends Component {
        ...
        onCreateSkillEffect(skillBulletObj, targetPos, angle, deltaTime) {
          if (deltaTime === void 0) {
            deltaTime = 0;
          }
          ...
          this.scheduleOnce(() => {
            var skillItem = null;
            var skillId = skillBulletObj.skillCfg.Id;
            var skillCom = null;
            ...
            if (this._skillPrefabItemMap.has(skillId)) {
              ...
              (_crd && ResourcesUtil === void 0 ? (_reportPossibleCrUseOfResourcesUtil({
                ...
                //加载资源
                var itemPath = (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                  error: Error()
                ...
                (_crd && ResourcesUtil === void 0 ? (_reportPossibleCrUseOfResourcesUtil({
                  ...
                  var iconSprite = skillItem.getChildByName('icon').getComponent(Sprite);
