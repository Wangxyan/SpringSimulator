  ...
  return {
    ...
    execute: function () {
      ...
      _export("SkillBulletBase", SkillBulletBase = (_dec = ccclass('SkillBulletBase'), _dec2 = property(Node), _dec(_class = (_class2 = class SkillBulletBase extends (_crd && BaseComponent === void 0 ? (_reportPossibleCrUseOfBaseComponent({
        ...
        //飞行时间
        get atkObj() {
          var atkObj = new (_crd && AtkObj === void 0 ? (_reportPossibleCrUseOfAtkObj({
            error: Error()
          }), AtkObj) : AtkObj)();
        ...
        initSkillBullet(targetPos, angel) {
          ...
          var curAngel = (_crd && Util === void 0 ? (_reportPossibleCrUseOfUtil({
            error: Error()
          }), Util) : Util).vector_to_angle(v2(vector.x, vector.y));
          var v = (_crd && Util === void 0 ? (_reportPossibleCrUseOfUtil({
            error: Error()
        ...
        easingSpeed(time, isAcc) {
          ...
          if (this.isEasing) {
            ...
            var speedTweenObj = new BintTweenObj();
            speedTweenObj.t = 0;
            tween(speedTweenObj).to(time, {
              ...
              onUpdate: (target, t) => {
                ...
                var y = p0.y * (1 - t) * (1 - t) * (1 - t) + 3 * p1.y * t * (1 - t) * (1 - t) + 3 * p2.y * t * t * (1 - t) + p3.y * t * t * t; //调试
        ...
        setBulletMove(dt) {
          if (this.skillBulletObj.skillCfg.Speed > 0) {
            var nodePos = this.node.getPosition();
            var dir = v3(this._dir.x, this._dir.y, 0);
        ...
        setBulletAngle(type) {
          switch (type) {
            case 1:
              //直线运动
              var r = new Vec2(this._dir.x, this._dir.y).signAngle(new Vec2(0, 1));
        ...
        updateSkillBulletScreen(dt) {
          //出屏幕移除
          var rect = new Rect(-(_crd && GameDefine === void 0 ? (_reportPossibleCrUseOfGameDefine({
            error: Error()
